...
#define  USART_ISR_PE                        ((uint32_t)0x00000010)            /*!< Parity Error */
#define  USART_ISR_ORE                      ((uint32_t)0x00000020)            /*!< OverRun Error */
#define  USART_ISR_FE                        ((uint32_t)0x00000040)            /*!< Framing Error */
#define  USART_ISR_IDLE                      ((uint32_t)0x00000020)            /*!< IDLE line detected */
#define  UCA0RXIFG                          (0x01)
#define  UCA0TXIFG                          (0x02)
#define  USART_ISR_TC                     ((uint32_t)0x00000000)             

#define USART_FLAG_PE                       USART_ISR_PE
#define USART_FLAG_ORE                     USART_ISR_ORE
#define USART_FLAG_FE                       USART_ISR_FE
#define USART_IT_RXNE                       UCA0RXIFG
